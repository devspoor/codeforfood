...
export async function PATCH(
  ...
  try {
    ...
    const allowedFields = ["title", "description", "amount", "hourly_rate", "estimated_hours", "hours_limit", "due_date", "is_recurring", "recurrence_interval", "recurrence_next_date", "recurrence_end_date"];
