      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <main className="flex-1 flex flex-col items-center justify-center px-4 py-16">
          <div className="max-w-3xl w-full text-center">
            ...
            {/* Tagline */}
            <p className="text-lg sm:text-xl text-muted mb-3 text-pretty">
              Project billing tracker for freelancers
            </p>
            <p className="text-sm text-muted/60 mb-10 max-w-md mx-auto text-pretty">
        ...
        <section id="features" className="px-4 py-20">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-center text-2xl font-bold mb-4 text-balance">How it works</h2>
            <p className="text-center text-muted text-sm mb-16 max-w-lg mx-auto text-pretty">
        ...
        <section className="px-4 py-16 border-t border-border/50">
          <div className="max-w-5xl mx-auto">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              <div>
                <p className="text-3xl font-bold gradient-text tabular-nums">$3.99</p>
        ...
        <section className="px-4 py-20 border-t border-border/50">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-center text-2xl font-bold mb-4 text-balance">Perfect for</h2>
          ...
          <div className="max-w-2xl mx-auto text-center">
            <div className="bg-card border border-border rounded-2xl p-8 sm:p-12">
              <div>
                ...
                <p className="text-muted/60 text-sm mb-8 max-w-md mx-auto text-pretty">
